...
const getHNComments = (articleCommentsHtml) => {
  ...
  const comments = getMatches(articleCommentsHtml, commentsRegex, nComments, 1)
  ...
  const commentsIndentation = getMatches(articleCommentsHtml, commentsIndentationRegex, nComments, 1)
